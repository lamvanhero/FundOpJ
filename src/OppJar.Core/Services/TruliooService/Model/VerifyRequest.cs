...
namespace OppJar.Core.Services.Model
{
    public class VerifyRequest
    {
        ...
        /// </summary>
        public bool AcceptTruliooTermsAndConditions { get; set; } = true;
        ...
        /// </summary>
        public bool CleansedAddress { get; set; } = false;
        ...
        /// </summary>
        public string ConfigurationName { get; set; } = "Identity Verification";
